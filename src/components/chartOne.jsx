    ...
    <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7 pb-5 shadow-xl sm:px-7 ">
      <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          ...
          <div className="flex min-w-47.5">
            <span className="mt-1 mr-2 flex h-3 w-3 items-center justify-center rounded-full border border-gray-250">
              <span className="block h-2.5 w-2.5 rounded-full bg-gray-150"></span>
            </span>
            <div className="w-full">
              <p className="font-semibold text-gray-150">Total Users</p>
              {/* <p className="text-sm font-medium text-gray-500">12.04.2022 - 12.05.2022</p> */}
            </div>
          </div>
        </div>
